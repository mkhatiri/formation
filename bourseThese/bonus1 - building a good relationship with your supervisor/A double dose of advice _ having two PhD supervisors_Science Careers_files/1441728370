...
if ( MM_FlashCanPlay ){
	...
	if( typeof( TFSMFlash_IMAGEALTERNATECLICK ) == "undefined" ) {
		...
		document.write(TFSMFlash_PRETAG+'<a href="'+TFSMFlash_IMAGEALTERNATECLICK+'" target="'+TFSMFlash_OASTARGET+'"><IMG SRC="'+TFSMFlash_IMAGEALTERNATE+'" '+TFSMFlash_OASDIM+' BORDER=0 alt="'+TFSMFlash_OASALTTEXT+'"></a>'+ TFSMFlash_POSTTAG);
	}
}
